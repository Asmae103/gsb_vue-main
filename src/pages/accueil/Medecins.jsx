...
/* function charger(e) {
  ...
  async function charger(e){
     ...
     try{
        ...
        const medecinsTrouves = await api.get('/medecins?nom='+valeursaisie); //// Appel à l'API pour récupérer les médecins
        console.log("Données reçues de l'API :", medecinsTrouves.data);
        setListeMedecins(medecinsTrouves.data);
...
/*useEffect(()=> { charger();
  ...
  <div style= {{
     ...
     boxSizing: 'border-box'
      ...
      <br/>
      <input  type ="text"  value={nomMedecin}  onChange= {charger}  style={{width: '96%' ,
        padding: '4px 20px',
        margin: '8px 10px',
        display: 'inline-block',
        border: '1px solid #ccc',
