...
function Fiche({leMedecin}){
  ...
  return(
    ...
    <>
      ...
      <ul>
        <li>
          <label type ="texte" id="nom">Nom: </label><br/>
          <input type="texte" id="nom"style={{   border: '1px solid #919191',
            borderRadius: '6px', width: '100%'}}/>
        </li>
        <li>
          <label type ="texte" id="prenom">Prenom: </label><br/>
          <input type="texte" id="prenom" style={{   border: '1px solid #919191',
            borderRadius: '6px', width: '100%'}}/>
        </li>
        <li>
          <label type ="texte" id="adresse">Adresse: </label><br/>
          <input type="texte" id="adresse" style={{   border: '1px solid #919191',
            borderRadius: '6px', width: '100%'}}/>
        </li>
        <li>
          <label type ="texte" id="adresse">Tel: </label><br/>
          <input type="texte" id="adresse" style={{   border: '1px solid #919191',
            borderRadius: '6px', width: '100%'}}/>
        </li>
        <li>
          <label type ="texte" id="adresse">Specialite Complementaire: </label><br/>
          <input type="texte" id="adresse" style={{   border: '1px solid #919191',
            borderRadius: '6px', width: '100%'}}/>
        </li>
        <li>
          <label type ="texte" id="adresse">departement: </label><br/>
          <input type="texte" id="adresse" style={{   border: '1px solid #919191',
            borderRadius: '6px', width: '100%'}}/>
        </li>
      </ul><br/>
